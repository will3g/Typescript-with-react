...
function setUsername(user) {
    if (user === void 0) { user = 'anônimo'; }
    return user;
}
function setEmail(email) {
    return email;
}
var example = setUsername(); // Aqui estamos dizendo que a variável username é uma string, pois o retorno
    ...
    index: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, res.json(usersList)];
            });
        });
    },
    create: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var emailservice, response;
            return __generator(this, function (_a) {
                emailservice = new EmailService_1.default(usersList[1].username, usersList[1].email);
